...
4. 确定`registry.cn-shanghai.aliyuncs.com/labring/kubernetes`、`registry.cn-shanghai.aliyuncs.com/labring/helm`、和`registry.cn-shanghai.aliyuncs.com/labring/cilium`的版本。
